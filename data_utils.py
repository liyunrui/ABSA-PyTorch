...
def build_tokenizer(fnames, max_seq_len, data_path, dat_fname):
    dat_fname = os.path.join(data_path, dat_fname)
...
def build_embedding_matrix(word2idx, embed_dim, data_path, dat_fname):
    dat_fname = os.path.join(data_path, dat_fname)
    if os.path.exists(dat_fname):
        ...
        fname = './glove.twitter.27B/glove.twitter.27B.' + str(embed_dim) + 'd.txt' \
            if embed_dim != 300 else '/dev/data/glove.42B.300d.txt'
